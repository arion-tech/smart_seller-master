...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBarAuthentication.setVisibility(View.INVISIBLE);
                          ...
                          public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                              try{
                                  ...
                                  try {
                                      ...
                                      Prefs.setPref(Prefs.APP_CONFIG, gson.toJson(appConfig), getBaseContext());
    ...
    private void subscribeDevice2(){
        if(!Prefs.getPref(Prefs.CLIENT_ID, SplashActivity.this).equals("") || Prefs.getPref(Prefs.CLIENT_ID, SplashActivity.this) != null) {
            ...
            //Call<String> callSync = service.
            // getToken(Prefs.getPref(Prefs.CLIENT_ID, SplashActivity.this));
            ...
            loginCall.enqueue(new Callback<ResponseBody>() {
                ...
                /*try {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        System.out.println("HEEEEEEEEEEEEEEEEEEEEREEEEE"+e.getMessage());
                    }
