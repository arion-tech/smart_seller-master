...
public class Prefs {
    ...
    public static final String ICONE_IMAGE = "ICONE_IMAGE";

    public static void setBooleanPref(String key, boolean value, Context ctx) {
        DebugLog.d("setPref[" + key + "]  " + value);
        SharedPreferences.Editor edit = ctx.getSharedPreferences(ctx.getResources().getString(R.string.app_name), MODE_PRIVATE).edit();
        edit.putBoolean(key, value).commit();
    }

    public static boolean getBooleanPref(String key, Context ctx, boolean defaultValue) {
        boolean value = ctx.getSharedPreferences(ctx.getResources().getString(R.string.app_name), MODE_PRIVATE).getBoolean(key, defaultValue);
    ...
    public static int getIntPref(String key, Context ctx) {
        int value = ctx.getSharedPreferences(ctx.getResources().getString(R.string.app_name), MODE_PRIVATE).getInt(key, 0);
        DebugLog.d("getPref[" + key + "]  " + value);
        return value;
    }
    ...
    public static String getPref(String key, Context ctx) {
        try {
            SharedPreferences appname = ctx.getSharedPreferences(ctx.getResources().getString(R.string.app_name), MODE_PRIVATE);
            String value = ctx.getSharedPreferences(ctx.getResources().getString(R.string.app_name), MODE_PRIVATE).getString(key, "");
            DebugLog.d("getPref[" + key + "]  " + value);
            return value;
        }catch (Exception ex){
    ...
    public static void clear(Context ctx) {
        ...
        ctx.getSharedPreferences(ctx.getResources().getString(R.string.app_name), MODE_PRIVATE).edit().clear().commit();
    ...
    public static Object getPrefObject(Class<?> cl, Context ctx) {
        ...
        try {
            ...
            for (Field f : cl.getFields()) {
                String value = ctx.getSharedPreferences(ctx.getResources().getString(R.string.app_name), MODE_PRIVATE).getString(className + "_" + f.getName(), null);
    ...
    public static void clearPref(Context ctx, String key) {
        ...
        ctx.getSharedPreferences(TAG, MODE_PRIVATE).edit().remove(key).commit();

    }



    public static void setPrefList(ArrayList list, String key, Context ctx) {

        DebugLog.d("getPreflist[" + key + "]  " + list);
        SharedPreferences.Editor edit = ctx.getSharedPreferences(ctx.getResources().getString(R.string.app_name), MODE_PRIVATE).edit();
        Gson gson = new Gson();
    ...
    public static ArrayList getPrefList(String key, Context ctx) {

        Gson gson = new Gson();
        String json = ctx.getSharedPreferences(ctx.getResources().getString(R.string.app_name), MODE_PRIVATE).getString(key, null);
        Type type = new TypeToken<ArrayList>() {}.getType();
        ArrayList mExampleList = gson.fromJson(json, type);

        if (mExampleList == null) {
            mExampleList = new ArrayList<>();
        }
        DebugLog.d("getPref[" + key + "]  " + mExampleList);
        return  mExampleList;
    }
